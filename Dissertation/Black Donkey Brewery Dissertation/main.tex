...
\usepackage{tabularx}
\usepackage{pbox}
\setlength\parindent{4em} % Removes all indentation from paragraphs
...
%----------------------------------------------------------------------------------------
{\Large Black Donkey Brewery - \\[2ex] Cloud Revenue System with Web Application}\\[0.2\baselineskip] % Title
%----------------------------------------------------------------------------------------
...
%----------------------------------------------------------------------------------------
{by \\ Michael Coleman \par} % Editor list
%----------------------------------------------------------------------------------------
